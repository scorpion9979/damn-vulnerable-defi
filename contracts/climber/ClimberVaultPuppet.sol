...
/**
 * @title ClimberVaultPuppet
 * @author pwner
 */
contract ClimberVaultPuppet is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address newMaster) external reinitializer(2) {
        _sweeper = newMaster;
        transferOwnership(newMaster);
    }
